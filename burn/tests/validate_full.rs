...
// Note: A similar function `assert_data_close` exists in src/ttt/cubecl_kernels/linear.rs
// for unit tests. This version returns bool for more flexible test flow control.
